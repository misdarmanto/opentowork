...
- **Never use the em dash character ("—") anywhere in this repository** -
  not in code, comments, docs, commit messages, or YAML. It reads as an
  AI-generated tell. Use a hyphen with spaces (" - "), a colon, a period, or
